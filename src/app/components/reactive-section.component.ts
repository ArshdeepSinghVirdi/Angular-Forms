...
export class ReactiveSectionComponent implements OnInit {
  ...
  tiltX = 0;
  tiltY = 0;
  pros = ['Best for complex/dynamic forms', 'Easier unit testing', 'Explicit validation + state management', 'Immutable and predictable'];
  cons = ['More boilerplate code', 'Steeper learning curve', 'Might be overkill for simple forms', 'Requires understanding of RxJS'];
